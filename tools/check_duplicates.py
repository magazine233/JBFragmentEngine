#!/usr/bin/env python3
"""Check for overlap in the verbs section of seed-taxonomies.json."""

import json
from pathlib import Path

DATA_PATH = Path(__file__).resolve().parents[1] / "data" / "seed-taxonomies.json"
...
for verb in verbs:
    ...
    for syn in synonyms:
        ...
        synonym_to_primary.setdefault(syn, []).append(primary)
